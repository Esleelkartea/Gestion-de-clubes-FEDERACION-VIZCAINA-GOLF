 ...
 * @author Julen
 */
public class confFotoDetServlet extends HttpServlet {
           ...
           if(request.getParameter("var")!=null)
             {
               ...
               {
                   request.getSession().setAttribute("fotoDetalle", null);
                   getServletContext().getRequestDispatcher("/configuracionFotosDet.jsp").forward(request, response);
               }
               else
               {
                    String idFoto = request.getParameter("var");
                    FotoDAL fotoDAL = new FotoDAL();
                    Foto unaFoto;
                    unaFoto = fotoDAL.getFoto(idFoto);
                    request.getSession().setAttribute("fotoDetalle", unaFoto);
