 ...
 * @author Julen
 */
public class confPagoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            TipoPago unTipoPago;
             if(request.getParameter("var")!=null)
             {
                ...
                unTipoPago = tipoPagoDAL.getTipoPago(Integer.parseInt(idTipoPago));
               request.getSession().setAttribute("tipoPago", unTipoPago);
             }
             else
             {
                 request.getSession().setAttribute("tipoPago", null);
             }
        ...
        finally
        {
            ...
            getServletContext().getRequestDispatcher("/configuracionPagos.jsp").forward(request, response);
            out.close();
        }
    } 
