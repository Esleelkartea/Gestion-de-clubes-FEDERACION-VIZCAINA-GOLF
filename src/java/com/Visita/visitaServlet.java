    ...
    throws ServletException, IOException {
       ...
       //Comprobacion del login
        ...
        try
        {
           ...
           ArrayList<Visita> listaVisita = new ArrayList<Visita>();
           if(request.getParameter("var")!=null)
             {
                String idVisita = request.getParameter("var");
                unaVisita = visitaDAL.getVisita(Integer.parseInt(idVisita));
                request.getSession().setAttribute("unaVisita", unaVisita);
             }
             else
             {
                request.getSession().setAttribute("unaVisita", null);
