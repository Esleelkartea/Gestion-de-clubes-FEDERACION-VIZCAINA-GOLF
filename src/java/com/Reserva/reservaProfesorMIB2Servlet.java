 ...
 * @author Julen
 */
public class reservaProfesorMIB2Servlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String nombre = request.getParameter("nombre");
            ...
            else
            {
                ...
                Profesor unProfesor = profesorDAL.getProfesor(Integer.parseInt(idProfesor));
                
                double importe = unProfesor.getImporte();

                ReservaProfesorDAL reservaProfesorDAL = new ReservaProfesorDAL();
                
                if(reservaProfesorDAL.insertarReservaProfesor(unProfesor.getIdProfesor(), Date.valueOf(fecha), Time.valueOf(horaInicio), Time.valueOf(horaFin), unSocio.getIdSocio(), importe, Integer.parseInt(estado), Integer.parseInt(formaPago)))
                {
        ...
        {
            request.getRequestDispatcher("reservaProfesorCompletada.jsp").forward(request, response);
            out.close();
        }
    } 
