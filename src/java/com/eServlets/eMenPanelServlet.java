 ...
 * @author Julen
 */
public class eMenPanelServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            listaMensajes = mensajeDAL.getMensaje(-1, null, null, unUsuario, null, null);

        }
        finally
        {
            request.getSession().setAttribute("listaMensajes", listaMensajes);
            getServletContext().getRequestDispatcher("/eMenPanel.jsp").forward(request, response);
            out.close();
        }
    } 
