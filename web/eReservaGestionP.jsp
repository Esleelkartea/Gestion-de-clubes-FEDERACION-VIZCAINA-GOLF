...
<div id="contenedor">
  ...
  <div id="submenu"><a href="eReservaAltaServlet">Alta de Reservas</a> &nbsp;|  &nbsp;<a href="eReservaGestionServlet">Listado de Reservas</a>&nbsp;|&nbsp;<a href="eReservaProfesorServlet">Reservas de Profesor</a>&nbsp;|&nbsp; Listado de Reservas de Profesor &nbsp;|&nbsp;<a href="eCursosInscritosServlet">Alta de Cursos</a>&nbsp;|&nbsp;<a href="eReservaGestionCursoServlet">Listado de Cursos</a></div>
	<div id="contenido">


   	  <div class="titulos2"><img src="imagenes/page_white_edit.png"/>Gestión de Reservas de Profesor</div>
          <br /><br />
    <%
        ArrayList<ReservaProfesor> listaReservasProfesor = (ArrayList<ReservaProfesor>)session.getAttribute("listaReservasProfesor");
        
    %>
    
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablas">
  	<tr>
   	  <td class="titulos_listado">Tipo Actividad</td>
   	  <td class="titulos_listado">Profesor</td>
   	  <td class="titulos_listado">Fecha</td>
   	  <td class="titulos_listado">Hora</td>
        ...
        <%
            if (listaReservasProfesor != null)
            {
                ...
                int idReserva;
                String strFecha;
                for (int i = 0; i<listaReservasProfesor.size(); i++)
                {

                    idProfesor = listaReservasProfesor.get(i).getIdProfesor();
                    unProfesor = profesorDAL.getProfesor(idProfesor);

                    idTipoActividad = unProfesor.getIdTipoInstalacion();
                    unTipoInstalacion = tipoInstalacionDAL.getTipoInstalacion(idTipoActividad);
                    
                    strFecha = String.valueOf(listaReservasProfesor.get(i).getFecha());
                    String[] arrFecha = strFecha.split("-");
                    strFecha = arrFecha[2] + "-" + arrFecha[1] + "-" + arrFecha[0];
                    
                    idReserva = listaReservasProfesor.get(i).getIdEstadoReserva();
        ...
        %>
                 ...
                 <tr>
                    ...
                    <td class="texto_listado"><%=unProfesor.getNombre()%></td>
                    <td class="texto_listado"><%=strFecha%></td>
                    <td class="texto_listado"><%=listaReservasProfesor.get(i).getHoraInicio()%></td>
                    <td class="texto_listado"><%=listaReservasProfesor.get(i).getImporte()%></td>

                    <%
                        if(listaReservasProfesor.get(i).getIdEstadoReserva()==1)
                        {
                    %>
