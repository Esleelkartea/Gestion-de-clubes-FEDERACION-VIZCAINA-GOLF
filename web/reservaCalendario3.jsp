...
<div id="contenido">
  ...
  <div class="marco">
   ...
   <form autocomplete="off" action="reservaCalendario3Servlet" method="post">
             ...
             <%
                if (listaInstalaciones != null && listaInstalaciones.size()!=0)
                {
                    ...
                    for(int i = 0; i<listaInstalaciones.size();i++)
                    {
                        ...
                        {
             %>
             <a style="color: red" href="reservaCalendario2Servlet?varInstalacion=<%=listaInstalaciones.get(i).getIdInstalacion()%>"><%=listaInstalaciones.get(i).getNombre()%></a>
             &nbsp;&nbsp;
              <%
                        }
                        else
