...
<div id="submenu">Gestión de Reservas &nbsp;|  <a href="reservaAltaServlet">Alta de Reservas</a> | <a href="reservaCalendarioServlet">Calendario de Reservas</a></div>
        ...
        <%
            ...
            if (resultadoSocio != null)
            {
                if (resultadoSocio == false)
                    resultado = "El socio introducido no existe";
            }
        %>

	<div class="capas_botones"><input name="buscar" type="submit" class="boton" id="buscar" value="Buscar" />
          ...
          <%
            ...
            if (listaReservas != null)
            {
                ...
                for (int i = 0; i<listaReservas.size(); i++)
                {
                    ...
                    unSocio = socioDAL.getSocio(idSocio);
   ...
   <div class="marco">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"> 
 	<tr>
 	  <td class="texto_formu" width="15%">Nombre Socio:</td>
 	  <td class="celda_campo">
              <label><input name="nombre" type="text" class="campo_texto" id="nombre" size="40" value="<%=strNombre%>" /></label></td>
 	  <td class="texto_formu" width="15%">Apellidos Socio:</td>
          <td class="celda_campo">
              <label><input name="apellidos" type="text" class="campo_texto" id="apellidos" size="40" value="<%=strApellidos%>" /></label></td>
 	  </tr>
       	<tr>
  	  <td class="texto_formu">Instalación:</td>
  	  <td class="celda_campo">
    ...
    <tr>
      ...
      <td class="celda_campo">
          <label><input name="horaInicio" type="text" class="campo_texto" id="hora" value="<%=strHoraInicio%>" /></label></td>
      <td class="texto_formu" width="15%">Hora Fin:</td>
      <td class="celda_campo">
          <label><input name="horaFin" type="text" class="campo_texto" id="hora" value="<%=strHoraFin%>" /></label></td>
    </tr>
  	</table>
	</div>
    ...
    <div class="capas_botones">
      <input name="enviar" type="submit" class="boton" id="modificar" value="Modificar" />
      <input name="enviar" type="submit" class="boton" id="baja" value="Baja" />
      <h5 style="color:red"><%=mib%><%=mibSocio%></h5>
    </div>
    ...
    <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tablas2">
  	<tr>
   	 <td style="text-align:right; float:right;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="flecha"><a href="#">&laquo;</a></td>
  </tr>
</table>
</td>
   	 <td class="titulos_general">MIÉRCOLES</td>
   	 <td class="titulos_general">JUEVES</td>
   	 <td class="titulos_general">VIERNES</td>
   	 <td class="titulos_general">SÁBADO</td>
   	 <td class="titulos_general">DOMINGO</td>
   	 <td class="titulos_general">LUNES</td>
   	 <td class="titulos_general">MARTES</td>
   	 <td class="flecha"><a href="#">&raquo;</a></td>
  	  </tr>
	<tr>
    	<td class="titulos_general">9:00</td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td rowspan="13">&nbsp;</td>
	...
	<tr>
	    <td class="titulos_general">10:00</td>
	...
	<tr>
	  <td class="titulos_general">11:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">12:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">13:00</td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">14:00</td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">15:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_generalRes">RESERVADO</td>
	...
	<tr>
	  <td class="titulos_general">16:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">17:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_generalRes">RESERVADO</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">18:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">19:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">20:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
	...
	<tr>
	  <td class="titulos_general">21:00</td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
    	<td class="texto_general"><a href="#">MOVER</a></td>
