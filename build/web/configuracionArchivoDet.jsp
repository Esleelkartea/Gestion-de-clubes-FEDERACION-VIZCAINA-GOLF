...
function validar() {
    ...
    miCampoTexto3 = document.getElementById("fichero").value;
     if(miCampoTexto.length == 0 || miCampoTexto3.length == 0)
     {
...
function validar2() {
     ...
     {
        alert("Debes rellenar el campo del Nombre");
        return false;
     }
     else
     {
...
<div id="contenedor">
   ...
   <form enctype="multipart/form-data" autocomplete="off" action="confArchivoMIBServlet" method="post" >

       <%
            Archivo unArchivo = (Archivo)session.getAttribute("archivoDetalle");
    	...
    	<input name="enviar" type="submit" class="boton" id="alta" value="Alta"  onclick="return validar()" />
          ...
          <div class="formulario">
           <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <td class="texto_formu" width="15%">Nombre:</td>
                <td width="34%" class="celda_campo">
                    <label><input name="nombre" type="text" class="campo_texto" id="nombre" size="40" value="<%=unArchivo.getNombre()%>" /></label></td>
            </tr>
