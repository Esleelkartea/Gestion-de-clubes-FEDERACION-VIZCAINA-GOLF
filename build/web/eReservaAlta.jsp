  	  ...
  	  <td class="celda_campo">
             ...
             <%
                if (listaTipoInstalaciones != null)
                {
                    ...
                    {
             %>   
             <a style="color: #008AFF; font-size: 12" href="eReservaAltaTipoServlet?varTipoInstalacion=<%=listaTipoInstalaciones.get(i).getIdTipoInstalacion()%>"><%=listaTipoInstalaciones.get(i).getNombre()%></a>
             &nbsp;&nbsp;
            <%   
                    }
                }
